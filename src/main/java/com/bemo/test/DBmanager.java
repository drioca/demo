   ...
   public void insert () {
      ...
      String iNs = "INSERT INTO test (age) VALUES (" + Integer.toString(UserData.age) +");";
        ...
        try {
         ...
         stmtc.executeUpdate("CREATE TABLE IF NOT EXSISTS test (key_column bigserial NOT NULL, age numeric(4,0), ctimestamp timestamptz DEFAULT now(), CONSTRAINT test_pkey PRIMARY KEY (key_column) );");
